...
public class Main_Viewpager_Fragment_2 extends Fragment {
...
//Begin On Create
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        item = inflater.inflate(R.layout.main_viewpager_fragment_2, container, false);

        listVideo = (RecyclerView) item.findViewById(R.id.newsong);
